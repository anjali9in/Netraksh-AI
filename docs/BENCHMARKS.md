...
_Note: Face detection runs 100% locally on the device with zero network calls._
...
_Note: Embeddings are compared locally using cosine similarity against templates stored securely in SQLite._
